...
public class MyWeb3Client {
    private Web3j web3j;
    private static final String WEB3_RPC_PROVIDER = "<<MAINNET_RPC>>";
    private static final String CONTRACT_ADDRESS = "<<MAINNET_CONTRACT_ADDRESS>>";
    ...
    public MyWeb3Client(KeyGenerator keyGenerator) {
        ...
        chainId = BigInteger.valueOf(5201420);
