...
public class MysticDiceResultActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_mystic_dice_result);
        ...
        LottieAnimationView lottieAnimationView = findViewById(R.id.dice_game_status_lottie_animation);
        TextView textView2X = findViewById(R.id.dice_game_status_text);
        TextView textViewDetails = findViewById(R.id.dice_game_details_text);
        TextView txnHashTextView = findViewById(R.id.dice_txn_hash_text);
        Button goToPlayButton = findViewById(R.id.dice_btn);
        ...
        txnHashTextView.setOnClickListener(e -> {
            if(txnHashTextView.isEnabled()) {
                ...
                ClipData clip = ClipData.newPlainText("txn_hash_from_mystic_dice_game", txnHashTextView.getText().toString().trim());

                // Copy the text to the clipboard
                clipboard.setPrimaryClip(clip);

                // Show a Toast confirmation
                Toast.makeText(MysticDiceResultActivity.this, "Transaction Hash copied to clipboard!", Toast.LENGTH_LONG).show();
            }
        });
        ...
        if(error != null) {
            ...
            goToPlayButton.setOnClickListener(e -> {
                Intent intent1 = new Intent(MysticDiceResultActivity.this, MainActivity.class);
